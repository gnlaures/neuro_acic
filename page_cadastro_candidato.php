				...
				<form action="#" class="c-simpleForm">
					...
					<div id="etapa-03" class="c-simpleForm__step">
						...
						<div class="c-defaultCard">
							<ul class="u-dflex">
								<li class="u-fw50">
									<label for="formUserRegistry_nome1">Primeiro nome*</label>
									<input id="formUserRegistry_nome1" type="text" name="nome1" class="field" required>
								</li>
								<li class="u-fw50">
									<label for="formUserRegistry_nome2">Sobrenome*</label>
									<input id="formUserRegistry_nome2" type="text" name="nome2" class="field" required>
								</li>
							</ul>
							<ul class="u-dflex">
								<li class="u-fw33">
									<label for="formUserRegistry_data">Data de nascimento*</label>
									<input id="formUserRegistry_data" type="text" class="field dataMask" name="data" placeholder="__/__/____" required>
								</li>
								<li class="u-fw33">
									<label for="formUserRegistry_telefone">Telefone principal*</label>
									<input id="formUserRegistry_telefone" type="tel" class="field foneMask" name="telefone" placeholder="(__) ____-_____" required>
								</li>
							</ul>
							<ul class="u-dflex">
								<li class="u-fw33 liSelectFull">
									<div class="selectBox">
										<label for="formUserRegistry_pcd">PCD?*</label>
										<select name="pcd" id="formUserRegistry_pcd" class="field" required>
								...
								<li class="u-fw66">
									<label for="formUserRegistry_pcdNome">Qual?</label>
									<input id="formUserRegistry_pcdNome" type="text" name="pcdNome" class="field">
								</li>
							</ul>
						</div>
					</div>
